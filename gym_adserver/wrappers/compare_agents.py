...
from gym_adserver.agents.thompson_agent import ThompsonAgent
...
if __name__ == '__main__':
    ...
    agents = [
        ...
        UCB1Agent(action_space=action_space, seed=args.seed, c=4, max_impressions=max_impressions),
        ThompsonAgent(action_space=action_space, seed=args.seed, max_impressions=max_impressions),
